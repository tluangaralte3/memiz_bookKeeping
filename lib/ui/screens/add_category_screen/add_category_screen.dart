...
import 'package:memiz_bk/ui/widgets/snack_bar_builder.dart';
                    ...
                    onPressed: !state.selectedIcon.iconId.isNegative &&
                        ...
                        ? () {
                            ...
                            buildShowSnackBar(context,
                                'Added category'); // Direct string replacement
                          }
                        : null,
                    child: SizedBox(
                      ...
                      child: Center(
                          heightFactor: 1,
                          child: Text(
                              'Add category')), // Direct string replacement
                    ));
              },
            ),
            appBar: BackAppBar(
              text: 'Add new', // Direct string replacement
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Category name', // Direct string replacement
                      ),
                    ),
                  ),
                ],
